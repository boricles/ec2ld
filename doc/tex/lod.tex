...
\conferenceinfo{I-SEMANTICS Triplification Challenge}{2012 Graz, Austria}
%\CopyrightYear{2007} % Allows default copyright year (20XX) to be over-ridden - IF NEED BE.
%\crdata{0-12345-67-8/90/01}  % Allows default copyright data (0-89791-88-6/97/05) to be over-ridden - IF NEED BE.
% --- End of Author Metadata ---

\title{EC2 AMI LinkedData}
%%
...
Idafen Santana P\'erez\\
       \affaddr{OEG-DIA}\\
       \affaddr{Facultad de Informática}\\
       \affaddr{Universidad Politécnica de Madrid}\\
...
Nandana Mihindukulasooriya\\
       ...
       \affaddr{Facultad de Informática}\\
       \affaddr{Universidad Politécnica de Madrid}\\
       \email{nandana@delicias.dia.fi.upm.es}
% 3rd. author
\alignauthor 
...
\keywords{linked data, linked open data}
...
This work has been supported by the R\&D project Seals. We would like to kindly thanks 
%
